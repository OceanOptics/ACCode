function amt241429924ACS = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   AMT241429924ACS = IMPORTFILE1(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   AMT241429924ACS = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   amt241429924ACS = importfile1('amt24_14_299_24_ACS.005', 96, 14496);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/09/13 10:53:53
...
amt241429924ACS = [dataArray{1:end-1}];
